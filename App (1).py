...
st.set_page_config(
   ...
   page_icon='./Logo/amey.png',
)
def run():
    img = Image.open('./Logo/amey.png')
    ...
    link = '[Developed by Amey Wani](https://www.linkedin.com/in/ameywani/)'
    ...
    if choice == 'User':
        st.markdown('''<h5 style='text-align: left; color: #ADD8E6 ;'> Upload your resume, and get smart recommendations</h5>''',
